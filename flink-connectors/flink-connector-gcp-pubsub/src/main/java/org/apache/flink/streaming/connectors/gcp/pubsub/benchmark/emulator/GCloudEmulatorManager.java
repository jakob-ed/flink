...
package org.apache.flink.streaming.connectors.gcp.pubsub.benchmark.emulator;
...
public class GCloudEmulatorManager {
    ...
    public static void launchDocker()
        ...
        portBindings.put(
                INTERNAL_PUBSUB_PORT, Collections.singletonList(PortBinding.randomPort("0.0.0.0")));
        ...
        final ContainerConfig containerConfig =
                ContainerConfig.builder()
                        ...
                        .cmd(
                                "sh",
                                "-c",
                                "mkdir -p /opt/data/pubsub ; gcloud beta emulators pubsub start --data-dir=/opt/data/pubsub --host-port=0.0.0.0:"
